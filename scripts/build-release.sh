...
function usage()
{
    ...
    echo "and generates the checksum files of the Kryptokrona tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/mevacoin/mevacoin.git"
CLONE_DIR="$BUILD_DIRECTORY/mevacoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/mevacoin-releases"
DYNAMIC_RELEASE="mevacoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="mevacoin-${TAG_VERSION}-linux-staticboost-CLI"
