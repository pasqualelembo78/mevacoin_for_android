...
# build the docker image for the mevacoin daemon, miner and xkrwallet etc 
...
#docker build -t mevacoin/mevacoin-testnet -f Dockerfile.test .

# pull latest testnet image (uncomment this if you want to build yourself)
docker pull ghcr.io/mevacoin/mevacoin-testnet:latest
