...
#include <sys/types.h>
#include <sys/socket.h>     // per socket, SOCK_STREAM
#include <netinet/in.h>     // per sockaddr_in, IPPROTO_TCP
#include <arpa/inet.h>      // per ntohl, inet_pton
#include <netdb.h>          // per addrinfo
